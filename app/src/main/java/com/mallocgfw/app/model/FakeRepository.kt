...
object FakeRepository {
    ...
    val protectedApps = listOf(
        ...
        ProtectedApp("com.android.vending", "Google Play", "系统", true),
        ProtectedApp("com.google.android.gms", "Google Play services", "系统", true),
        ProtectedApp("com.google.android.gsf", "Google Services Framework", "系统", true),
        ProtectedApp("com.android.providers.downloads", "Download Manager", "系统", true),
